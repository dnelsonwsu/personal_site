...
var DateTimeShortcuts = {
    ...
    init: function() {
        ...
        if (window.__admin_media_prefix__ != undefined) {
            ...
            var questionmark_index = DateTimeShortcuts.admin_media_prefix.indexOf("?");

            if(questionmark_index > 0)
            {
                DateTimeShortcuts.admin_media_prefix = DateTimeShortcuts.admin_media_prefix.substring(0,questionmark_index) + "/";
            }
